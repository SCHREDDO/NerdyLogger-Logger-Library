...
public abstract class LogMessageFormat {
	
	public LogMessageFormat() {
		
	}

	public abstract String formatLogMessage(String message, LogLevel loggerLevel);

	public abstract String formatLogMessage(String message, String logMessageTemplate, LogLevel loggerLevel);
}
