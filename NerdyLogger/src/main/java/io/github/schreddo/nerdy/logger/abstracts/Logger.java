...
public abstract class Logger {
	...
	public abstract int log(String message);

	public abstract int log(LogLevel logLevel, String message);

	public abstract int log(LogLevel logLevel, String message, boolean isMessageTemplate);

	public abstract int fatal(String message);

	public abstract int error(String message);

	public abstract int warning(String message);

	public abstract int info(String message);

	public abstract int debug(String message);

	public abstract int trace(String message);

	public abstract int createBackup();

	public abstract int clearLog();

	public abstract boolean createLogFile();
}
